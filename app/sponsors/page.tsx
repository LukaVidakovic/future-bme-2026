                        ...
                        <div className="text-center">
                          ...
                          <div className="flex items-center justify-center gap-2 flex-wrap">
                            {[...Array(tier.stars)].map((_, i) => {
                              const extractedColors = tier.metalGradient.match(/#[A-Fa-f0-9]{6}/gi) || [];
                              const colors = [
                                extractedColors[0] || '#E5E7EB',
                                extractedColors[1] || '#FFFFFF', 
                                extractedColors[2] || '#D1D5DB'
                              ];
                              return (
                                <motion.div
                                  key={i}
                                ...
                                >
                                  ...
                                  >
                                    <defs>
                                      <linearGradient id={`star-${tier.name.replace(/\s+/g, '-')}-${i}`} x1="0%" y1="0%" x2="100%" y2="100%">
                                    ...
                                    <path 
                                      ...
                                      fill={`url(#star-${tier.name.replace(/\s+/g, '-')}-${i})`}
                                      stroke={colors[1]}
                                      strokeWidth="0.5"
                                    />
                                  </svg>
