...
const topics = [
  {
    title: 'Business, Management & Human Resources',
    icon: (
    ...
    items: [
      ...
      'Sustainable Business Models in the Agricultural and Seed Sector',
    ],
  },
  {
    ...
    items: [
      ...
      'Green Finance, ESG Investments, and Economic Resilience',
  ...
  {
    title: 'Engineering, Construction & Economic Engineering',
    icon: (
      <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    items: [
      ...
      'Circular Design in Built Environment',
      'Sustainable Urban Mobility and Green Logistics',
      'Architectural Engineering and Cultural Heritage Preservation',
    ],
  },
  {
    title: 'Digital Transformation, Data & AI',
    icon: (
      <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    items: [
      ...
      'Automation, Robotics, and Smart Production Systems',
  ...
  {
    title: 'Sustainability, Energy & Environmental Practice',
    icon: (
      <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    items: [
      ...
      'Sustainable Occupational Health & Safety Practices',
  ...
  {
    title: 'Design, Innovation & Entrepreneurship',
    icon: (
      <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Healthcare & Hospitality Management',
    icon: (
      <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <main className="min-h-screen pt-20">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-[var(--navy)] to-[var(--teal)]/20">
        <div className="w-full max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 [&>*:last-child:nth-child(odd)]:md:col-span-2 [&>*:last-child:nth-child(odd)]:md:max-w-2xl [&>*:last-child:nth-child(odd)]:md:mx-auto">
            {topics.map((topic, index) => (
              <motion.div
                ...
                className="group p-6 md:p-8 rounded-2xl bg-gradient-to-br from-[var(--blue)]/30 to-[var(--teal)]/20 backdrop-blur-xl border border-[var(--blue-light)]/40 hover:border-[var(--purple)]/60 transition-all duration-300 hover:shadow-[0_0_30px_rgba(105,80,222,0.3)]"
              >
                <div className="flex items-start gap-4 mb-6">
                  <div className="flex-shrink-0 w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br from-[var(--purple)] to-[var(--blue-light)] rounded-xl flex items-center justify-center p-2.5 md:p-3 text-white group-hover:scale-110 transition-transform duration-300">
                    {topic.icon}
                  </div>
                  <h2 className="text-xl md:text-2xl font-bold text-white group-hover:text-[var(--purple)] transition-colors leading-tight">
                    {topic.title}
                  </h2>
                </div>
                <ul className="space-y-3">
                  {topic.items.map((item, i) => (
                    <li key={i} className="flex items-center gap-3 group/item">
                      <div className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-gradient-to-r from-[var(--purple)] to-[var(--blue-light)] group-hover/item:scale-150 transition-transform duration-300" />
                      <span className="text-white/90 text-sm md:text-base leading-relaxed group-hover/item:text-white transition-colors">{item}</span>
                    </li>
                  ))}
                </ul>
              </motion.div>
        ...
        <div className="w-full max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-lg text-[var(--gray-light)] mb-8">
              Review our submission guidelines and join us in shaping the future
            </p>
